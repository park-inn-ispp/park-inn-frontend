...
export default function Terminos(){
    return (
        ...
        <Parrafo>
            ...
            LICENCIA
            <br/>
            <strong>Park-Inn</strong>  a través de su sitio web concede una licencia para que los usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.
